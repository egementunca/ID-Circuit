...
from .database import JobRecord, CircuitDatabase
...
class JobQueueManager:
    ...
    def _register_default_handlers(self):
        ...
        self.job_handlers[JobType.ML_FEATURE_EXTRACTION] = self._handle_ml_feature_extraction
    ...
    def _process_job(self, job: JobRecord, job_type: JobType):
        ...
        try:
            ...
            self.database.update_job_status(
                job.id, JobStatus.COMPLETED.value,
                result=result
            )
    ...
    def _handle_unrolling(self, parameters: Dict[str, Any]) -> Dict[str, Any]:
        ...
        unroll_types = parameters.get('unroll_types', ['swaps', 'rotations', 'permutations'])
    ...
    def _handle_ml_feature_extraction(self, parameters: Dict[str, Any]) -> Dict[str, Any]:
...
class AsyncJobQueueManager:
    ...
    def _register_default_handlers(self):
        ...
        self.job_handlers[JobType.ML_FEATURE_EXTRACTION] = self._handle_ml_feature_extraction_async
    ...
    # Async job handlers
    async def _handle_seed_generation_async(self, parameters: Dict[str, Any]) -> Dict[str, Any]:
        """Handle seed generation jobs asynchronously."""
        # Simulate async work
        await asyncio.sleep(0.1)
        return self._handle_seed_generation(parameters)
    
    async def _handle_unrolling_async(self, parameters: Dict[str, Any]) -> Dict[str, Any]:
        """Handle circuit unrolling jobs asynchronously."""
        await asyncio.sleep(0.1)
        return self._handle_unrolling(parameters)
    
    async def _handle_post_processing_async(self, parameters: Dict[str, Any]) -> Dict[str, Any]:
        """Handle post-processing jobs asynchronously."""
        await asyncio.sleep(0.1)
        return self._handle_post_processing(parameters)
    
    async def _handle_debris_analysis_async(self, parameters: Dict[str, Any]) -> Dict[str, Any]:
        """Handle debris cancellation analysis jobs asynchronously."""
        await asyncio.sleep(0.1)
        return self._handle_debris_analysis(parameters)
    
    async def _handle_ml_feature_extraction_async(self, parameters: Dict[str, Any]) -> Dict[str, Any]:
        """Handle ML feature extraction jobs asynchronously."""
        await asyncio.sleep(0.1)
        return self._handle_ml_feature_extraction(parameters)
    
    async def _handle_parquet_export_async(self, parameters: Dict[str, Any]) -> Dict[str, Any]:
